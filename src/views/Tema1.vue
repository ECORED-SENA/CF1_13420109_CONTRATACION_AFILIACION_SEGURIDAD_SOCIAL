...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    br
    .titulo-segundo.mt-5
      h2#t_1_1 1.1  Preselección laboral
    ...
    .row.mt-5.p-5(style="background-color:#16697A;border-radius:20px;")
      ...
      .col-md-8(style="place-self:center")
        SlyderF(columnas="col-lg-6 col-xl-6")
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Recepción de hojas de vida.
            p Como resultado de la gestión hecha en la convocatoria laboral. 
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Revisión de cumplimiento del perfil solicitado.
            p Se realiza un filtro de las hojas de vida comparando el perfil requerido, versus el que se presenta para determinar la idoneidad del postulado. 
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Citación del candidato para presentar pruebas.
            p Pueden ser psicotécnicas, de conocimiento, personalidad, de campo, polígrafo, entre otras.
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Entrevistas
            p El candidato pasa por una o varias entrevistas que pueden ser estructuradas, no estructuradas o mixtas. Los entrevistadores pueden implementar métodos como, por ejemplo, entrevistas de panel, grupales, estudios de casos y utilizar medios telefónicos y virtuales para el desarrollo tanto de la entrevistas como de las pruebas.
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Verificación de los datos de la hoja de vida.
            p Verificación de antecedentes y referenciación de datos de estudio, laboral, familiares, disciplinarios, legales e inclusive si es necesario, visita domiciliaria.
          .tarjeta.color-acento-botones.p-4(style="background-color:#D0EAE2;min-height:330px;")
            h4 Exámenes médicos.
            p Una vez el candidato es aprobado, es enviado a exámenes médicos ocupacionales de ingreso.

    br
    br
    .titulo-segundo.mt-5
      h2#t_1_2 1.2  Valoración de resultados y decisión de contratar

    p(data-aos="fade-up") El área encargada de contratación recibe los resultados de todo el proceso, se reúne con las partes interesadas dando un informe de cada aspirante al cargo y toman la decisión de seleccionar al que mejor cumple con los requisitos del perfil solicitado.
